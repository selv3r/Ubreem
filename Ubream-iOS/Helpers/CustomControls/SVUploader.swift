...
//  ihere
//
//  Created by abdelrahman on 7/12/17.
...
class SVUploader: UIView {
    ...
    //var SVBorderColor = UIColor(red:0.55, green:0.55, blue:0.55, alpha:1.0) {
    var SVBorderColor = UIColor.clear {
        didSet { circleBorderLayer.strokeColor = SVBorderColor.cgColor }
    }
    
    /** The width of the border */
    var SVborderWidth: CGFloat = 0 {
        didSet { circleBorderLayer.lineWidth = SVborderWidth }
    }
    ...
    init(lineColor: UIColor, lineWidth: CGFloat, SVBorderColor: UIColor, SVborderWidth: CGFloat) {
        super.init(frame: CGRect(x: 0, y: 0, width: 0, height: 0))
        
        self.lineColor = lineColor
        self.lineWidth = lineWidth
        self.SVBorderColor = SVBorderColor
        self.SVborderWidth = SVborderWidth
    ...
    func setup() {
        ...
        circleBorderLayer.lineWidth = SVborderWidth
        circleBorderLayer.strokeColor = SVBorderColor.cgColor
    ...
    override func layoutSubviews() {
        ...
        // Offset the border ring by (lineWidth + SVborderWidth/20
        self.circleBorderLayer.frame = self.bounds
        let borderFrame = circleBorderLayer.frame.insetBy(dx: lineWidth + SVborderWidth/2, dy: lineWidth + SVborderWidth/2)
        circleBorderLayer.path = UIBezierPath(ovalIn: borderFrame).cgPath
        
        // Offset the content view by (lineWidth + SVborderWidth)
        containerView.frame = self.frame.insetBy(dx: lineWidth + SVborderWidth, dy: lineWidth + SVborderWidth)
        containerView.frame.uploaderCenter = containerView.superview!.center
        ...
        endImageView.frame.uploaderCenter = endImageView.superview!.center
